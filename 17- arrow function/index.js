...
// Define a Arrow function called greet that takes a parameter name and returns a greeting message
// including the provided name. Then, call the greet Arrow function with
// the argument "John" and log the result to the console.
//answer
//let guestName= "zartasha khan";
var greetings = function (name) {
    var message = ('thankyou for coming');
